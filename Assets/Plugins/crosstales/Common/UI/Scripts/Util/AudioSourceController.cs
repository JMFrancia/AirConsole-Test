...
namespace Crosstales.UI.Util
{
   ...
   public class AudioSourceController : MonoBehaviour
   {
      ...
      [Tooltip("Mute on/off (default: false).")] public bool Mute = false;

      /// <summary>Loop on/off (default: false).</summary>
      [Tooltip("Loop on/off (default: false).")] public bool Loop = false;
      ...
      [Tooltip("Stereo pan of the audio (default: 0).")] public float StereoPan = 0f;
