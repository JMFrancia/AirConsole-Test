...
namespace Crosstales.RTVoice.Util
{
   ...
   public abstract class Constants : Common.Util.BaseConstants
   {
      ...
      public const string ASSET_VERSION = "2020.1.5";

      /// <summary>Build number of the asset.</summary>
      public const int ASSET_BUILD = 20200420;
      ...
      public static readonly System.DateTime ASSET_CHANGED = new System.DateTime(2020, 4, 20);
